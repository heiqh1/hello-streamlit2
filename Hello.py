...
def run():
    ...
    st.write("Dikembangkan oleh Rizqi Maulana Putra.")
    ...
    st.write("## Input bahan makanan")

    c1 = st.number_input("Beras", min_value=0.0, max_value=1.0, value=0.0, step=0.1)
    c2 = st.number_input("Air Mineral", min_value=0.0, max_value=1.0, value=0.0, step=0.1)
    c3 = st.number_input("Telur", min_value=0.0, max_value=1.0, value=0.0, step=0.1)
    c4 = st.number_input("Mie", min_value=0.0, max_value=1.0, value=0.0, step=0.1)
    c5 = st.number_input("Gula", min_value=0.0, max_value=1.0, value=0.0, step=0.1)
